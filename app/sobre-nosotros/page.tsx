...
const TEAM = [
  { iniciales: 'WJ', color: 'var(--color-brand-600)', nombre: 'Walter Jaramillo', rol: 'Co-Founder & CEO', bio: 'Ingeniero industrial matemático, apasionado por la innovación y las operaciones. Lidera la visión y estrategia de Reachly.', linkedin: 'https://www.linkedin.com/in/walter-jaramillo-3b325425b/' },
    ...
    <div className="bg-background">
      ...
      <section className="py-20 px-[5%]">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[.12em] text-brand-400 mb-3">Nuestra misión</p>
          ...
          <div className="bg-gradient-to-br from-brand-600 to-brand-800 rounded-2xl p-7">
      ...
      {/* Valores */}
      <section className="py-16 px-[5%] bg-reachly-bg dark:bg-background">
        <div className="max-w-[1100px] mx-auto">
          <p className="text-xs font-semibold uppercase tracking-[.12em] text-brand-400 mb-10">Nuestros valores</p>
      ...
      {/* Stats band */}
      <div className="bg-brand-950 py-10 px-[5%]">
      ...
      <section className="py-20 px-[5%]">
        <div className="max-w-[1100px] mx-auto">
          <p className="text-xs font-semibold uppercase tracking-[.12em] text-brand-400 mb-10">El equipo</p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {TEAM.map(m => (
              <div key={m.nombre} className="bg-card border border-border rounded-2xl p-7 text-center flex flex-col items-center">
                ...
                <p className="text-xs text-reachly-text3 font-medium tracking-wide mb-3">{m.rol}</p>
      ...
      <div className="py-16 px-[5%]">
        <div className="max-w-[1100px] mx-auto">
          <div className="bg-white dark:bg-card border border-border rounded-2xl p-12 text-center">
            <h3 className="text-2xl font-bold text-foreground mb-2">¿Quieres ser parte de lo que construimos?</h3>
            <p className="text-muted-foreground text-sm mb-7">Únete como influencer, marca, o suma a nuestra causa como parte del equipo.</p>
            <div className="flex flex-wrap gap-3 justify-center">
              <Link href="/registro" className="bg-brand-600 text-white font-semibold text-sm px-7 py-3 rounded-xl hover:bg-brand-500 transition-colors">
                Crear cuenta gratis
              </Link>
