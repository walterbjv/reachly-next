  ...
  return (
    <div className="max-w-[900px] mx-auto px-[5%] py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground">Para consultas de medios, escribinos a <span className="text-brand-400">prensa@reachly.app</span></p>
      </div>

      {/* Kit de prensa */}
      <div className="bg-gradient-to-br from-brand-600 to-brand-800 rounded-2xl p-8 text-white mb-10 flex flex-wrap items-center justify-between gap-4">
        <div>
        ...
        <button className="bg-white text-brand-600 font-semibold text-sm px-6 py-2.5 rounded-xl hover:bg-brand-50 transition-colors">
          Descargar kit
        </button>
      </div>
      ...
      <div className="space-y-4 mb-12">
        {NOTAS.map(n => (
          <div key={n.titulo} className="bg-card border border-border rounded-xl p-5 flex items-center gap-4 hover:border-brand-300 transition-colors">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold text-brand-400 mb-1">{n.medio} · {n.fecha}</p>
